...
| Packages | ◐ | Packages no heap, `DEFPACKAGE`, listas de uso, exportação/importação/uninterning, consulta exata e seu estado, símbolos qualificados, adoção de símbolos não internados e persistência em imagem funcionam; faltam shadowing, apelidos, remoção de packages e o protocolo completo de conflitos. |
