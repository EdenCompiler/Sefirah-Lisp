...
Ctrl+Home/End moves to document boundaries, and adding Shift selects those spans;
...
limites de tokens Lisp, Ctrl+Home/End move aos limites do documento, e acrescentar
Shift seleciona esses intervalos; digitar
