...
| Conditions | ◐ | Condition objects, `ERROR`, `HANDLER-CASE`, and `IGNORE-ERRORS` work; restarts, handler binding, standard hierarchy coverage, and debugger integration are missing. |
